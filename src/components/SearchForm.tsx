    ...
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="relative">
          <label htmlFor='from' id = "from" className="block text-sm font-medium text-gray-700 mb-1">From</label>
          <div id = "from" className="relative">
            <MapPin id = "from" className="absolute left-3 top-3 h-5 w-5 text-gray-400" />
            <select id = "from"
              value={from}
